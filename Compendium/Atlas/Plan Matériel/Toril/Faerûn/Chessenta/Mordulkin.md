...
tags:
 - location/city
headerLink: "[[Mordulkin#Mordulkin]]"
---
...
> [!quote|no-t] RÉSUMÉ
> Une cité-état dirigée par des mages en [[Chessenta]].
...
FROM "Compendium/Atlas/Plan Matériel/Toril/Faerûn/Chessenta/Mordulkin"
WHERE type= "landmark"
SORT file.name ASC
>
>> [!note]- HISTOIRE
>>```dataview
LIST WITHOUT ID headerLink
FROM "Session Notes" AND [[Mordulkin]]
